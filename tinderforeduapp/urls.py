...
urlpatterns = [
    ...
    path('<int:user_id>/your_subject/', views.my_profile, name ='your_subject'),
    ...
    path('<int:user_id>/another_profile',views.another_profile,name="another_profile"),
    ...
    path('adddata/', views.facebook_additional_data_request, name ='adddata'),
